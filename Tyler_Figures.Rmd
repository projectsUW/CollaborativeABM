...
p + facet_grid(PopStakeholders ~ strategy) + 
  labs(title = "Relationship of max support and max voice organized by\n  inviting strategy, population, & number of coalitions",x="Voice when max support achieved",y="max level of support achieved", colour="Coalitions") + guides(colour = guide_legend(override.aes = list(alpha = 1,size=10))) + theme_tufte(ticks=F) + 
